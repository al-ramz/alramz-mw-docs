...
- [Bank Integration Services](#bank-integration-services)
...
- [Stage 1 — processCashInRequests](#stage-1-processcashinrequests)
- [Stage 2 — createRVForCashInRequests](#stage-2-creatervforcashinrequests)
- [Stage 3 — rejectPendingCashInRequests](#stage-3-rejectpendingcashinrequests)
...
![Figure 1 — As-Built: two independent packages, two banks, two directions of money movement.](media/fig1_asbuilt.png)
...
![Figure 3 — Cash-IN journey (BankIntegration/ADCB) vs. Cash-OUT journey (CorporateBanking/ADIB).](media/fig3_journeys.png)
...
![Figure 2 — Target: standard bank-integration service, shared chassis + bank-specific adapters.](media/fig2_target.png)
...
![Figure 4 — Target Process Flow, createRvByDetailID, Spring Boot 3.x.](media/fig4_createrv_flow.png)
...
![Figure 5 — Target Process Flow, Scheduled Cash-In Reconciliation Engine, Spring Boot 3.x.](media/fig5_batch_engine.png)
...
| **Backing service** | CorporateBanking.ADIB.common.ws.providers.restAPI.CorporateBanking_.services:GetAccountDetails |
...
![Figure 7 — Target Process Flow, submitDomesticTransfer, Spring Boot 3.x.](media/fig7_payment_flow.png)
...
![Figure 6 — Target Process Flow (shared shape), ADIB inquiry endpoints: getAccounts, accounts/getTransactions, payments/getTransactions.](media/fig6_inquiry_flow.png)
...
| DB Column (P_ prefix, as passed to the stored procedure) | Purpose |
|---|---|
